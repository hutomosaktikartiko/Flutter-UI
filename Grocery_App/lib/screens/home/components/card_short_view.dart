...
class CardShowView extends StatelessWidget {
  const CardShowView({Key? key, required this.controller}) : super(key: key);
          ...
          child: Row(
            children: List.generate(
                ...
                (index) => Padding(
                      ...
                      child: Hero(
                        tag:
                            controller.cart[index].product!.title! + "_cartTag",
                        child: CircleAvatar(
